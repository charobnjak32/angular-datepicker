...
Module.constant('dateTimeConfig', {
  template: function (attrs, id) {
    return '' +
      ...
      'class="date-picker-date-time ' + (attrs.datePickerPanelClass || '') + '"></div>';
  },
...
$templateCache.put('templates/datepicker.html',
    ...
    "        <th colspan=\"5\" class=\"switch\" ng-click=\"setView('month')\" ng-bind=\"viewDate|mFormat:'YYYY MMMM':tz\"></th>\n" +
    ...
    "      <tr>\n" +
    "        <th ng-click=\"prev()\">&lsaquo;</th>\n" +
    "        <th colspan=\"5\" class=\"switch\" ng-click=\"setView('year')\" ng-bind=\"viewDate|mFormat:'YYYY':tz\"></th>\n" +
    "        <th ng-click=\"next()\">&rsaquo;</i></th>\n" +
    "      </tr>\n" +
    "      </thead>\n" +
    "      <tbody>\n" +
